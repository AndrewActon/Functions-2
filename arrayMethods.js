...
// CODE HERE
const evenNumbers = mixedNumbers.filter(numbers => numbers % 2 === 0)
...
// CODE HERE
const totalPopulation = populations.reduce((total, pop) => total + pop)
...
// CODE HERE
const totalPrices = orders.map(total => total.price * (1 + total.tax))
...
// CODE HERE
const bobsTotal = purchases.filter(owner => owner.owner === 'Bob').reduce((total, price) => total + price.price, 0)
